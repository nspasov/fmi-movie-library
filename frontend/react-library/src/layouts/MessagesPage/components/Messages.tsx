...
import { useOktaAuth } from "@okta/okta-react";import MessageModel from "../../../models/MessageModel";
    ...
    return (
        <div className="mt-2">
            {messages.length > 0 ?
                            ...
                            <div className="card mt-2 shadow p-3 bg-body rounded">
                                ...
                                <div>
                                    ...
                                    {message.response && message.adminEmail ? 
                                        ...
                                        :
                                        <p><i>Pending response.. will get back to you</i></p>
                                    }
                                </div>
                            </div>
                        </div>
                ...
                :
                <h5>Questions you submit will appear here</h5>
            }
